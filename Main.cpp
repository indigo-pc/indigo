...
int main() {
    ...
    std::cout << "uWatt per cm^2: " << s.computeMicrowattsPerCmSquared( 0, -1 ) << "\n";
    std::cout << "uWatt: " << s.computeMicrowatts( 0, -1, collectionArea ) << "\n";
    std::cout << "Joules: " << s.computeJoules( 0, -1, collectionArea, integrationTime ) << "\n";
    std::cout << "eV: " << s.computeElectronVolts( 0, -1, collectionArea, integrationTime ) << "\n";
    std::cout << "Lux: " << s.computeLuxPhotopic( ) << "\n";
    std::cout << "Candella: " << s.computeCandella( Spectrum{ photopicEfficiencyData, wavelengths }, peakPhotopicLuminosity, collectionArea, solidAngle ) << "\n";
    std::cout << "Photons per cm^2 per s: " << s.computePhotonsPerCmSquaredPerSecond( 0, -1 ) << "\n";
    std::cout << "Total photons: " << s.computeTotalPhotons( 0, -1, collectionArea, integrationTime ) << "\n";
