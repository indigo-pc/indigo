...
class Spectrum {
    ...
    public:
        ...
        static Spectrum createGaussian( std::vector<double> & abscissa, const double & maxValue, const double & centerValue, const double & rmsWidth );
        ...
        static inline int lowerBound = 0;
        static inline int upperBound = -1;
